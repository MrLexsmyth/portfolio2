...
const projectData = [
  ...
  },
  {
    ...
    description: `A digital measurement management system for tailors and fashion designers.`,
  ...
  },
  {
    ...
    techs: ["reactjs.svg", "javascript.svg", "tailwindcss.svg", "sass.svg", "framer-motion.svg", "next.svg"],
  },
  {
    title: "Nigerian Institution Of Surveyors",
    image: "/nis.png",
    description: `Manages member registration, payments, and public directory access with admin dashboard.`,
    live: "https://nigerian-institutionof-surveyors.vercel.app/",
    techs: ["reactjs.svg", "javascript.svg", "tailwindcss.svg", "sass.svg", "framer-motion.svg", "next.svg", "express.svg", "git.svg", "mongodb.svg", "node.svg", "typescript.svg"],
  },
  {
    title: "Larx Clothinz",
    image: "/ecommence.png",
    description: `A sleek and modern online fashion store built for style and convenience.`,
    live: "https://larxclothing.vercel.app/",
    code: "https://github.com/MrLexsmyth/larxclothing",
    techs: ["reactjs.svg", "javascript.svg", "tailwindcss.svg", "redux.svg", "sass.svg", "firebase.svg"],
  },
  {
    ...
    techs: ["reactjs.svg", "typescript.svg", "framermotion.svg", "tailwindcss.svg", "redux.svg", "next.svg"],
  },
  {
    title: "A CBT Quiz",
    image: "/cbt.png",
    ...
    techs: ["reactjs.svg", "firebase.svg", "tailwindcss.svg", "javascript.svg"],
  },
  {
  ...
  },
  {
    ...
    image: "/church.png",
    description: `Beautifully crafted platform representing identity of a church.`,
...
const PortfolioPage = () => {
  return (
    <div className="relative h-screen bg-[#022c43] overflow-hidden px-6 md:px-16 py-10">
      ...
      {/* Title */}
      <div className="relative inline-block text-white font-bold mt-8 text-3xl md:text-5xl mb-8 text-center md:text-left">
        <span className="block text-yellow-400 text-sm opacity-60 mb-2 select-none">&lt;h1&gt;</span>
        <AnimatedText>
          <span>Portfolio</span>
        </AnimatedText>
        <span className="block text-yellow-400 text-sm opacity-60 mt-2 select-none">&lt;/h1&gt;</span>
      </div>
